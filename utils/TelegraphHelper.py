...
class TelegraphHelper():
    ...
    SOURCE_DIR = "sources/natal_chart/pre_generated_images"
    def __init__(self):
        self.HEADER = _(
        ...
        self.TOPIC_IMAGES = {
            "Male": [
                "Man_Strengths_Weaknesses-min.png",
                "Man_Career_Realization-min.png",
                "Man_Mission-min.png",
                "Man_Relationships-min.png",
                "Man_Harmony_and_balance-min.png",
                "Man_Finance-min.png",
                "Man_Blog_topics-min.png",
                "Man_Success_story-min.png"
            ],
            "Female": [
                "Woman_Strengths_Weaknesses-min.png",
                "Woman_Career_Realization-min.png",
                "Woman_Mission-min.png",
                "Woman_Relationships-min.png",
                "Woman_Harmony_and_balance-min.png",
                "Woman_Finance-min.png",
                "Woman_Blog_topics-min.png",
                "Woman_Success_story-min.png"
            ]
        }
