...
def prepare_router() -> Router:
    ...
    user_router.callback_query.register(natal_chart.callback_get_gender, GendersCallback.filter())
    user_router.message.register(natal_chart.handle_birthday, NatalStates.get_birthday)
    user_router.callback_query.register(natal_chart.callback_set_default_birthtime, lambda c: c.data == "/set_default_birthtime")
